package com.amii.miniprogram.api.controller;
...
import com.amii.miniprogram.api.dispatch.TestServiceDispatch;
import com.amii.miniprogram.api.dispatch.VoteActivityServiceDispatch;
import com.amii.miniprogram.api.exception.AppException;
import com.amii.miniprogram.api.util.ApiToolkit;
import com.amii.miniprogram.api.util.ConfigToolkit;
import com.amii.miniprogram.api.util.JsonToolkit;
import com.amii.miniprogram.api.util.LogToolkit;
import com.amii.miniprogram.api.util.StringToolkit;
import com.amii.miniprogram.api.util.response.ApiResponse;

@RestController
public class GatewayController
{
    @Autowired
    private VoteActivityServiceDispatch voteActivityServiceDispatch;
    ...
    public ApiResponse gatewayApi (HttpServletRequest request)
    {
        ...
        try {
            ...
            // 是否启用签名
            Boolean signEnable = "false".equals(ConfigToolkit.getProperty("app_signEnable").toLowerCase()) ? false : true;
            ...
            LogToolkit.saveToLog(ae); // 记录异常到日志
            ...
            LogToolkit.saveToLog(e); // 记录异常到日志
    ...
    private Object requestService (String method, String bizContent) throws AppException
    {
        ...
        try {
            ...
            throw new AppException(ApiConstant.Message.CODE_14009, 14009);
        }

        // 路由字典
        Map<String, String> serviceRoutes = new HashMap<String, String>();
        serviceRoutes.put("amii.miniprogram.test.test", "TestService.test");
        serviceRoutes.put("amii.miniprogram.vote.publish", "VoteActivityService.publishVoteActivity");
        serviceRoutes.put("amii.miniprogram.vote.detail", "VoteActivityService.detailVoteActivity");
        serviceRoutes.put("amii.miniprogram.vote.list", "VoteActivityService.listVoteActivity");
        ...
        // 调用VoteActivityService
        else if ("VoteActivityService".equals(serviceClass)) {
            data = voteActivityServiceDispatch.requestMethod(serviceMethod, serviceParams);
        }
